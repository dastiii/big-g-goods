  ...
  <div class="relative bg-gray-800 overflow-hidden border-b-4 border-brand">
    <div class="max-w-7xl mx-auto">
      <div class="relative z-10 bg-gray-800 lg:max-w-2xl lg:w-full">
        ...
        <main class="mx-auto max-w-7xl px-4 lg:pr-24">
          <div class="sm:text-center lg:text-left py-8">
            ...
            <p class="mt-4 max-w-2xl text-xl text-gray-400 md:mx-auto">
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
      <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="@/assets/map.jpg" alt="">
    </div>
  </div>
</template>
